...
STATS_REQUEST_DELAY_MS = max(0, _int("STATS_REQUEST_DELAY_MS", "50"))
MAX_TIPS_PER_RUN = max(1, _int("MAX_TIPS_PER_RUN", "50"))
MIN_CONFIDENCE_TO_SEND = _float01("MIN_CONFIDENCE_TO_SEND", "0.75")
...
LIVE_MAX_FIXTURES = _int("LIVE_MAX_FIXTURES", "50")
